...
// associative arrays like map
    ...
    $grades =array("arabic"=>10 , "math"=>15 , "English"=>12);
        ...
        foreach($grades as $grade) echo $grade. "--";
        
        echo "<br>";

        foreach($grades as $subject=>$grade) echo $subject." =".$grade."<br>";
        ...
        foreach($gr as $name=>$numbers){
            echo $name."   ";
             foreach($grades as $subject=>$grade)echo $subject." =".$grade." | ";
             echo "<br>";
        } 
